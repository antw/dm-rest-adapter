...
Gem::Specification.new do |s|
  ...
  s.authors = ["Anthony Williams", "Scott Burton @ Joyent Inc"]
  s.date = %q{2011-03-16}
  s.description = %q{REST Adapter for DataMapper}
  s.email = ["hi@antw.me", "scott.burton [a] joyent [d] com"]
  s.extra_rdoc_files = [
    "LICENSE",
    "README.rdoc"
  ]
  s.files = [
    ...
    "lib/dm-rest-adapter/formats/json.rb",
    "lib/dm-rest-adapter/formats/xml.rb",
    "lib/dm-rest-adapter/spec/setup.rb",
    "spec/factories/book.rb",
    "spec/fixtures/book.rb",
    "spec/fixtures/difficult_book.rb",
    "spec/public/create_spec.rb",
    "spec/public/destroy_spec.rb",
    "spec/public/read_spec.rb",
    "spec/public/update_spec.rb",
    "spec/rcov.opts",
    "spec/semipublic/connection_spec.rb",
    "spec/spec.opts",
    "spec/spec_helper.rb",
    "spec/support/format_helpers.rb",
    "spec/support/shared_get_request_examples.rb",
    "spec/support/shared_post_request_examples.rb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<dm-sweatshop>, ["~> 1.1.0"])
      ...
      s.add_dependency(%q<dm-sweatshop>, ["~> 1.1.0"])
